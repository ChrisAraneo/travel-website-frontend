        ...
        return (
            <nav id="navigation">
                <ul className="columns">
                    <li className="column">
                        <a className={`button is-rounded is-primary is-fullwidth ${props.setPageToGlobe ? '' : 'is-active'}`}
                            onClick={event => { event.preventDefault(); if (props.setPageToGlobe) { props.setPageToGlobe(); } }}>
                            Globus
                    </a>
                    </li>
                    <li className="column">
                        <a className={`button is-rounded is-primary is-fullwidth ${props.setPageToTravelList ? '' : 'is-active'}`}
